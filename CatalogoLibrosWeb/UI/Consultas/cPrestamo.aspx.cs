...
namespace CatalogoLibrosWeb.UI.Consultas
{
    public partial class cPrestamo : System.Web.UI.Page
    {
        ...
        public void LlenaReport()
        {
            ...
            MyReportViewer.LocalReport.ReportPath = Server.MapPath(@"~\UI\Reportes\ListadoPrestamo.rdlc");
            MyReportViewer.LocalReport.DataSources.Clear();
            MyReportViewer.LocalReport.DataSources.Add(new ReportDataSource("EditorialDS", Utils.FPrestamo()));
        ...
        protected void buscarLinkButton_Click(object sender, EventArgs e)
        {
            ...
            ConsultaGridView.DataSource = Utils.FiltrarPrestamo(index, CriterioTextBox.Text, desde, hasta);
