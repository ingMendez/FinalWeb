...
{
    public partial class cLibro : System.Web.UI.Page
    {
        ...
        public void LlenaReport()
        {
            ...
            MyReportViewer.LocalReport.ReportPath = Server.MapPath(@"~\UI\Reportes\ListadoLibro.rdlc");
        ...
        protected void buscarLinkButton_Click(object sender, EventArgs e)
        {
            ...
            ConsultaGridView.DataSource = Utils.FiltrarLibro(index, CriterioTextBox.Text, desde, hasta);
