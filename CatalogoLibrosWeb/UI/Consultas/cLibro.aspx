<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cLibro.aspx.cs" Inherits="CatalogoLibrosWeb.UI.Consultas.cLibro" %>
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="form-group col-md-2">
                    ...
                    <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control" runat="server">
                        ...
                        <asp:ListItem>LibroID</asp:ListItem>
                    ...
                    <div class="form-row justify-content-center">
                        <asp:GridView ID="ConsultaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NombreLibro" HeaderText="NombreLibro" />
                                <asp:BoundField DataField="ISBN" HeaderText="ISBN" />
                                <asp:BoundField DataField="CategoriaID" HeaderText="CategoriaID"/>
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" />
                                <asp:BoundField DataField="EditorialID" HeaderText="EditorialID" />
                                <asp:BoundField DataField="FechaImpresion" HeaderText="FechaImpresion" />
                                <asp:BoundField DataField="Disponibilidad" HeaderText="prestado" />
                            </Columns>
