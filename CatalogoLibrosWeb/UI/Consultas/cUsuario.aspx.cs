...
namespace CatalogoLibrosWeb.UI.Consultas
{
    public partial class cUsuario : System.Web.UI.Page
    {
            ...
            public void LlenaReport()
            {
                ...
                MyReportViewer.LocalReport.ReportPath = Server.MapPath(@"~\UI\Reportes\ListadoUsuario.rdlc");
                MyReportViewer.LocalReport.DataSources.Clear();
                MyReportViewer.LocalReport.DataSources.Add(new ReportDataSource("UsuarioDs", Utils.FUsuario()));
