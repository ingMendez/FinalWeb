<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cUsuario.aspx.cs" Inherits="CatalogoLibrosWeb.UI.Consultas.cUsuario" %>
            ...
            <div class="card-body">
                ...
                <div class="form-row justify-content-center">
                    <asp:GridView ID="ConsultaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                        ...
                        <Columns>
                            <asp:BoundField DataField="UsuarioId" HeaderText="Categoria ID" />
                            <asp:BoundField DataField="Nombres" HeaderText="Nombre" />
                            <asp:BoundField DataField="NoTelefono" HeaderText="descripcion" />
                            <asp:BoundField DataField="Email" HeaderText="Email" />
                            <asp:BoundField DataField="pocision" HeaderText="Nivel" />
