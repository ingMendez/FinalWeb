<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cEditorial.aspx.cs" Inherits="CatalogoLibrosWeb.UI.Consultas.cEditorial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card-header text-uppercase text-center">Consultar Editorial</div>
    <div class="card-body">
        <div class="form-row justify-content-center">
            ...
            <div class="form-group col-md-2">
                ...
                <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control" runat="server">
                    ...
                    <asp:ListItem>Editoria lID</asp:ListItem>
            ...
            <div class="card-body">
                ...
                <div class="form-row justify-content-center">
                    <asp:GridView ID="ConsultaGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                        ...
                        <Columns>
                            <asp:BoundField DataField="EditorialID" HeaderText="Editorial ID" />
                            <asp:BoundField DataField="Nombre" HeaderText="Nombre" />
                            <asp:BoundField DataField="Dirrecion" HeaderText="Dirrecion" />
