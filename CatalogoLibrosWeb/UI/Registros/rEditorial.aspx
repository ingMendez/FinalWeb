<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rEditorial.aspx.cs" Inherits="CatalogoLibrosWeb.UI.Registros.rEditorial" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card text-white bg-dark mb-3">
        <div class="card-header text-uppercase text-center">Registro Editorial</div>
                ...
                <div class="form-horizontal col-md-12" role="form">
                    ...
                    <div class="form-group row control-label" style="align-items: center;">
                        ...
                        <div class="col-md-1 col-sm-2 col-xs-4">
                            <asp:Button ID="BuscarB_Click" runat="server" Text="Buscar" ValidationGroup="ValidacionBE" class="btn btn-info btn-md" OnClick="BuscarButton_Click" />
                        </div>
